...
// The SLotDef class is not a subclass of MonoBehavious, so it doesn't need a serparate 
// c# file

[System.Serializable]	// This make SlotDegs visible in the Unity Inspector pane
...
public class Layout : MonoBehaviour {
	...
	// SlotDef references
	public List<SlotDef>		slotDefs;	// All the SlotDefs are for Row0-Row3
	...
	public void ReadLayout (string xmlText) {
		...
		for (int i = 0; i < slotsX.Count; i++) {
			...
			if (slotsX[i].HasAtt ("type")){
				...
				// If not, set its type to "slot"; its a tableau card
				tSD.type = "slot";
			}
			...
			// The layers are used to make sure that the correc cards are
